...
• **new IoCollapsable**(`properties?`, ...`args`)
...
[elements/layout/collapsable.ts:47](https://github.com/io-gui/iogui/blob/tsc/src/elements/layout/collapsable.ts#L47)
...
[elements/layout/collapsable.ts:19](https://github.com/io-gui/iogui/blob/tsc/src/elements/layout/collapsable.ts#L19)
...
[elements/layout/collapsable.ts:60](https://github.com/io-gui/iogui/blob/tsc/src/elements/layout/collapsable.ts#L60)

___

### connect

▸ **connect**(`node?`): [`IoCollapsable`](IoCollapsable.md)
...
▸ **disconnect**(`node?`): [`IoCollapsable`](IoCollapsable.md)
