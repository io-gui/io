...
- [constructor](IoMenuTree.md#constructor)

### Properties

- [$](IoMenuTree.md#$)
- [$parent](IoMenuTree.md#$parent)
- [\_bindings](IoMenuTree.md#_bindings)
- [\_changeQueue](IoMenuTree.md#_changequeue)
- [\_eventDispatcher](IoMenuTree.md#_eventdispatcher)
- [\_properties](IoMenuTree.md#_properties)
- [\_protochain](IoMenuTree.md#_protochain)
- [class](IoMenuTree.md#class)
- [contenteditable](IoMenuTree.md#contenteditable)
- [depth](IoMenuTree.md#depth)
- [disabled](IoMenuTree.md#disabled)
- [hidden](IoMenuTree.md#hidden)
- [id](IoMenuTree.md#id)
- [label](IoMenuTree.md#label)
- [name](IoMenuTree.md#name)
- [options](IoMenuTree.md#options)
- [role](IoMenuTree.md#role)
- [search](IoMenuTree.md#search)
- [searchable](IoMenuTree.md#searchable)
- [slotted](IoMenuTree.md#slotted)
- [tabindex](IoMenuTree.md#tabindex)
- [title](IoMenuTree.md#title)

### Accessors

- [textNode](IoMenuTree.md#textnode)
- [Listeners](IoMenuTree.md#listeners)
- [Properties](IoMenuTree.md#properties)
- [Style](IoMenuTree.md#style)

### Methods

- [Register](IoMenuTree.md#register)
- [\_flattenTextNode](IoMenuTree.md#_flattentextnode)
- [\_onCollapse](IoMenuTree.md#_oncollapse)
- [\_onItemClicked](IoMenuTree.md#_onitemclicked)
- [addEventListener](IoMenuTree.md#addeventlistener)
- [applyProperties](IoMenuTree.md#applyproperties)
- [bind](IoMenuTree.md#bind)
- [changed](IoMenuTree.md#changed)
- [connectedCallback](IoMenuTree.md#connectedcallback)
- [disabledChanged](IoMenuTree.md#disabledchanged)
- [disconnectedCallback](IoMenuTree.md#disconnectedcallback)
- [dispatchEvent](IoMenuTree.md#dispatchevent)
- [dispatchMutationEvent](IoMenuTree.md#dispatchmutationevent)
- [dispatchQueue](IoMenuTree.md#dispatchqueue)
- [dispatchQueueSync](IoMenuTree.md#dispatchqueuesync)
- [dispose](IoMenuTree.md#dispose)
- [init](IoMenuTree.md#init)
- [inputValue](IoMenuTree.md#inputvalue)
- [labelChanged](IoMenuTree.md#labelchanged)
- [objectMutated](IoMenuTree.md#objectmutated)
- [onObjectMutated](IoMenuTree.md#onobjectmutated)
- [queue](IoMenuTree.md#queue)
- [removeEventListener](IoMenuTree.md#removeeventlistener)
- [setAttribute](IoMenuTree.md#setattribute)
- [setProperties](IoMenuTree.md#setproperties)
- [setProperty](IoMenuTree.md#setproperty)
- [template](IoMenuTree.md#template)
- [throttle](IoMenuTree.md#throttle)
- [traverse](IoMenuTree.md#traverse)
- [unbind](IoMenuTree.md#unbind)

## Constructors

### constructor

• **new IoMenuTree**(`...args`): [`IoMenuTree`](IoMenuTree.md)
...
[src/elements/menus/io-menu-tree.ts:56](https://github.com/io-gui/io/blob/main/src/elements/menus/io-menu-tree.ts#L56)
