...
- [constructor](IoColorPicker.md#constructor)

### Properties

- [$](IoColorPicker.md#$)
- [\_bindings](IoColorPicker.md#_bindings)
- [\_changeQueue](IoColorPicker.md#_changequeue)
- [\_eventDispatcher](IoColorPicker.md#_eventdispatcher)
- [\_properties](IoColorPicker.md#_properties)
- [\_protochain](IoColorPicker.md#_protochain)
- [class](IoColorPicker.md#class)
- [contenteditable](IoColorPicker.md#contenteditable)
- [disabled](IoColorPicker.md#disabled)
- [hidden](IoColorPicker.md#hidden)
- [id](IoColorPicker.md#id)
- [label](IoColorPicker.md#label)
- [name](IoColorPicker.md#name)
- [role](IoColorPicker.md#role)
- [tabindex](IoColorPicker.md#tabindex)
- [title](IoColorPicker.md#title)
- [value](IoColorPicker.md#value)

### Accessors

- [expanded](IoColorPicker.md#expanded)
- [textNode](IoColorPicker.md#textnode)
- [Listeners](IoColorPicker.md#listeners)
- [Properties](IoColorPicker.md#properties)
- [Style](IoColorPicker.md#style)

### Methods

- [Register](IoColorPicker.md#register)
- [\_flattenTextNode](IoColorPicker.md#_flattentextnode)
- [\_onClick](IoColorPicker.md#_onclick)
- [\_onKeydown](IoColorPicker.md#_onkeydown)
- [\_onValueSet](IoColorPicker.md#_onvalueset)
- [addEventListener](IoColorPicker.md#addeventlistener)
- [applyProperties](IoColorPicker.md#applyproperties)
- [bind](IoColorPicker.md#bind)
- [changed](IoColorPicker.md#changed)
- [collapse](IoColorPicker.md#collapse)
- [connectedCallback](IoColorPicker.md#connectedcallback)
- [disabledChanged](IoColorPicker.md#disabledchanged)
- [disconnectedCallback](IoColorPicker.md#disconnectedcallback)
- [dispatchEvent](IoColorPicker.md#dispatchevent)
- [dispatchMutationEvent](IoColorPicker.md#dispatchmutationevent)
- [dispatchQueue](IoColorPicker.md#dispatchqueue)
- [dispatchQueueSync](IoColorPicker.md#dispatchqueuesync)
- [dispose](IoColorPicker.md#dispose)
- [expand](IoColorPicker.md#expand)
- [init](IoColorPicker.md#init)
- [inputValue](IoColorPicker.md#inputvalue)
- [labelChanged](IoColorPicker.md#labelchanged)
- [objectMutated](IoColorPicker.md#objectmutated)
- [onObjectMutated](IoColorPicker.md#onobjectmutated)
- [queue](IoColorPicker.md#queue)
- [removeEventListener](IoColorPicker.md#removeeventlistener)
- [setAttribute](IoColorPicker.md#setattribute)
- [setProperties](IoColorPicker.md#setproperties)
- [setProperty](IoColorPicker.md#setproperty)
- [template](IoColorPicker.md#template)
- [throttle](IoColorPicker.md#throttle)
- [toggle](IoColorPicker.md#toggle)
- [traverse](IoColorPicker.md#traverse)
- [unbind](IoColorPicker.md#unbind)

## Constructors

### constructor

• **new IoColorPicker**(`...args`): [`IoColorPicker`](IoColorPicker.md)
...
[src/elements/color/io-color-picker.ts:32](https://github.com/io-gui/io/blob/main/src/elements/color/io-color-picker.ts#L32)
...
[src/elements/color/io-color-picker.ts:22](https://github.com/io-gui/io/blob/main/src/elements/color/io-color-picker.ts#L22)
...
[src/elements/color/io-color-picker.ts:38](https://github.com/io-gui/io/blob/main/src/elements/color/io-color-picker.ts#L38)
...
[src/elements/color/io-color-picker.ts:24](https://github.com/io-gui/io/blob/main/src/elements/color/io-color-picker.ts#L24)
...
[src/elements/color/io-color-picker.ts:10](https://github.com/io-gui/io/blob/main/src/elements/color/io-color-picker.ts#L10)
...
[src/elements/color/io-color-picker.ts:35](https://github.com/io-gui/io/blob/main/src/elements/color/io-color-picker.ts#L35)
...
[src/elements/color/io-color-picker.ts:41](https://github.com/io-gui/io/blob/main/src/elements/color/io-color-picker.ts#L41)
...
[src/elements/color/io-color-picker.ts:59](https://github.com/io-gui/io/blob/main/src/elements/color/io-color-picker.ts#L59)
...
[src/elements/color/io-color-picker.ts:81](https://github.com/io-gui/io/blob/main/src/elements/color/io-color-picker.ts#L81)
...
[src/elements/color/io-color-picker.ts:77](https://github.com/io-gui/io/blob/main/src/elements/color/io-color-picker.ts#L77)
...
[src/elements/color/io-color-picker.ts:69](https://github.com/io-gui/io/blob/main/src/elements/color/io-color-picker.ts#L69)
...
[src/elements/color/io-color-picker.ts:62](https://github.com/io-gui/io/blob/main/src/elements/color/io-color-picker.ts#L62)
