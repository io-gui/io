...
- [constructor](IoNotify.md#constructor)

### Properties

- [$](IoNotify.md#$)
- [\_bindings](IoNotify.md#_bindings)
- [\_changeQueue](IoNotify.md#_changequeue)
- [\_eventDispatcher](IoNotify.md#_eventdispatcher)
- [\_properties](IoNotify.md#_properties)
- [\_protochain](IoNotify.md#_protochain)
- [class](IoNotify.md#class)
- [contenteditable](IoNotify.md#contenteditable)
- [disabled](IoNotify.md#disabled)
- [hidden](IoNotify.md#hidden)
- [id](IoNotify.md#id)
- [label](IoNotify.md#label)
- [name](IoNotify.md#name)
- [role](IoNotify.md#role)
- [tabindex](IoNotify.md#tabindex)
- [title](IoNotify.md#title)

### Accessors

- [textNode](IoNotify.md#textnode)
- [Listeners](IoNotify.md#listeners)
- [Properties](IoNotify.md#properties)
- [Style](IoNotify.md#style)

### Methods

- [Register](IoNotify.md#register)
- [\_flattenTextNode](IoNotify.md#_flattentextnode)
- [\_onAgree](IoNotify.md#_onagree)
- [\_onDisgree](IoNotify.md#_ondisgree)
- [addEventListener](IoNotify.md#addeventlistener)
- [applyProperties](IoNotify.md#applyproperties)
- [bind](IoNotify.md#bind)
- [changed](IoNotify.md#changed)
- [connectedCallback](IoNotify.md#connectedcallback)
- [disabledChanged](IoNotify.md#disabledchanged)
- [disconnectedCallback](IoNotify.md#disconnectedcallback)
- [dispatchEvent](IoNotify.md#dispatchevent)
- [dispatchMutationEvent](IoNotify.md#dispatchmutationevent)
- [dispatchQueue](IoNotify.md#dispatchqueue)
- [dispatchQueueSync](IoNotify.md#dispatchqueuesync)
- [dispose](IoNotify.md#dispose)
- [init](IoNotify.md#init)
- [inputValue](IoNotify.md#inputvalue)
- [labelChanged](IoNotify.md#labelchanged)
- [objectMutated](IoNotify.md#objectmutated)
- [onObjectMutated](IoNotify.md#onobjectmutated)
- [queue](IoNotify.md#queue)
- [removeEventListener](IoNotify.md#removeeventlistener)
- [setAttribute](IoNotify.md#setattribute)
- [setProperties](IoNotify.md#setproperties)
- [setProperty](IoNotify.md#setproperty)
- [template](IoNotify.md#template)
- [throttle](IoNotify.md#throttle)
- [traverse](IoNotify.md#traverse)
- [unbind](IoNotify.md#unbind)

## Constructors

### constructor

• **new IoNotify**(`props?`): [`IoNotify`](IoNotify.md)
...
[src/elements/notify/io-notify.ts:64](https://github.com/io-gui/io/blob/main/src/elements/notify/io-notify.ts#L64)
...
[src/elements/notify/io-notify.ts:60](https://github.com/io-gui/io/blob/main/src/elements/notify/io-notify.ts#L60)
...
[src/elements/notify/io-notify.ts:52](https://github.com/io-gui/io/blob/main/src/elements/notify/io-notify.ts#L52)
...
[src/elements/notify/io-notify.ts:10](https://github.com/io-gui/io/blob/main/src/elements/notify/io-notify.ts#L10)
...
[src/elements/notify/io-notify.ts:74](https://github.com/io-gui/io/blob/main/src/elements/notify/io-notify.ts#L74)
...
[src/elements/notify/io-notify.ts:79](https://github.com/io-gui/io/blob/main/src/elements/notify/io-notify.ts#L79)
