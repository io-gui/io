...
> **getSlotted**(): `null` \| [`VDOMArray`](../type-aliases/VDOMArray.md)

Defined in: [src/elements/content/io-navigator-base.ts:114](https://github.com/io-gui/io/blob/main/src/elements/content/io-navigator-base.ts#L114)

#### Returns

`null` \| [`VDOMArray`](../type-aliases/VDOMArray.md)
