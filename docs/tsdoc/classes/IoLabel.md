...
- [constructor](IoLabel.md#constructor)

### Properties

- [$](IoLabel.md#$)
- [\_bindings](IoLabel.md#_bindings)
- [\_changeQueue](IoLabel.md#_changequeue)
- [\_eventDispatcher](IoLabel.md#_eventdispatcher)
- [\_properties](IoLabel.md#_properties)
- [\_protochain](IoLabel.md#_protochain)
- [class](IoLabel.md#class)
- [contenteditable](IoLabel.md#contenteditable)
- [disabled](IoLabel.md#disabled)
- [hidden](IoLabel.md#hidden)
- [id](IoLabel.md#id)
- [label](IoLabel.md#label)
- [name](IoLabel.md#name)
- [role](IoLabel.md#role)
- [tabindex](IoLabel.md#tabindex)
- [title](IoLabel.md#title)

### Accessors

- [textNode](IoLabel.md#textnode)
- [Properties](IoLabel.md#properties)
- [Style](IoLabel.md#style)

### Methods

- [Register](IoLabel.md#register)
- [\_flattenTextNode](IoLabel.md#_flattentextnode)
- [addEventListener](IoLabel.md#addeventlistener)
- [applyProperties](IoLabel.md#applyproperties)
- [bind](IoLabel.md#bind)
- [changed](IoLabel.md#changed)
- [connectedCallback](IoLabel.md#connectedcallback)
- [disabledChanged](IoLabel.md#disabledchanged)
- [disconnectedCallback](IoLabel.md#disconnectedcallback)
- [dispatchEvent](IoLabel.md#dispatchevent)
- [dispatchMutationEvent](IoLabel.md#dispatchmutationevent)
- [dispatchQueue](IoLabel.md#dispatchqueue)
- [dispatchQueueSync](IoLabel.md#dispatchqueuesync)
- [dispose](IoLabel.md#dispose)
- [init](IoLabel.md#init)
- [inputValue](IoLabel.md#inputvalue)
- [labelChanged](IoLabel.md#labelchanged)
- [objectMutated](IoLabel.md#objectmutated)
- [onObjectMutated](IoLabel.md#onobjectmutated)
- [queue](IoLabel.md#queue)
- [removeEventListener](IoLabel.md#removeeventlistener)
- [setAttribute](IoLabel.md#setattribute)
- [setProperties](IoLabel.md#setproperties)
- [setProperty](IoLabel.md#setproperty)
- [template](IoLabel.md#template)
- [throttle](IoLabel.md#throttle)
- [traverse](IoLabel.md#traverse)
- [unbind](IoLabel.md#unbind)

## Constructors

### constructor

• **new IoLabel**(`...args`): [`IoLabel`](IoLabel.md)
...
[src/elements/basic/io-label.ts:6](https://github.com/io-gui/io/blob/main/src/elements/basic/io-label.ts#L6)
...
[src/elements/basic/io-label.ts:23](https://github.com/io-gui/io/blob/main/src/elements/basic/io-label.ts#L23)
