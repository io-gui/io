...
- [constructor](IoMenuItem.md#constructor)

### Properties

- [$](IoMenuItem.md#$)
- [$options](IoMenuItem.md#$options)
- [\_bindings](IoMenuItem.md#_bindings)
- [\_changeQueue](IoMenuItem.md#_changequeue)
- [\_eventDispatcher](IoMenuItem.md#_eventdispatcher)
- [\_properties](IoMenuItem.md#_properties)
- [\_protochain](IoMenuItem.md#_protochain)
- [appearance](IoMenuItem.md#appearance)
- [class](IoMenuItem.md#class)
- [contenteditable](IoMenuItem.md#contenteditable)
- [depth](IoMenuItem.md#depth)
- [direction](IoMenuItem.md#direction)
- [disabled](IoMenuItem.md#disabled)
- [expanded](IoMenuItem.md#expanded)
- [hidden](IoMenuItem.md#hidden)
- [icon](IoMenuItem.md#icon)
- [id](IoMenuItem.md#id)
- [invalid](IoMenuItem.md#invalid)
- [item](IoMenuItem.md#item)
- [label](IoMenuItem.md#label)
- [name](IoMenuItem.md#name)
- [placeholder](IoMenuItem.md#placeholder)
- [role](IoMenuItem.md#role)
- [selected](IoMenuItem.md#selected)
- [stroke](IoMenuItem.md#stroke)
- [tabindex](IoMenuItem.md#tabindex)
- [title](IoMenuItem.md#title)
- [value](IoMenuItem.md#value)

### Accessors

- [$parent](IoMenuItem.md#$parent)
- [hasmore](IoMenuItem.md#hasmore)
- [inlayer](IoMenuItem.md#inlayer)
- [textNode](IoMenuItem.md#textnode)
- [Listeners](IoMenuItem.md#listeners)
- [Properties](IoMenuItem.md#properties)
- [Style](IoMenuItem.md#style)

### Methods

- [Register](IoMenuItem.md#register)
- [\_expandHovered](IoMenuItem.md#_expandhovered)
- [\_flattenTextNode](IoMenuItem.md#_flattentextnode)
- [\_gethovered](IoMenuItem.md#_gethovered)
- [\_onBlur](IoMenuItem.md#_onblur)
- [\_onClick](IoMenuItem.md#_onclick)
- [\_onCollapse](IoMenuItem.md#_oncollapse)
- [\_onCollapseRoot](IoMenuItem.md#_oncollapseroot)
- [\_onFocus](IoMenuItem.md#_onfocus)
- [\_onFocusTo](IoMenuItem.md#_onfocusto)
- [\_onItemClicked](IoMenuItem.md#_onitemclicked)
- [\_onKeydown](IoMenuItem.md#_onkeydown)
- [\_onKeyup](IoMenuItem.md#_onkeyup)
- [\_onOverlayPointermove](IoMenuItem.md#_onoverlaypointermove)
- [\_onOverlayPointerup](IoMenuItem.md#_onoverlaypointerup)
- [\_onPointerdown](IoMenuItem.md#_onpointerdown)
- [\_onPointerdownAction](IoMenuItem.md#_onpointerdownaction)
- [\_onPointerleave](IoMenuItem.md#_onpointerleave)
- [\_onPointermove](IoMenuItem.md#_onpointermove)
- [\_onPointermoveAction](IoMenuItem.md#_onpointermoveaction)
- [\_onPointerup](IoMenuItem.md#_onpointerup)
- [\_onPointerupAction](IoMenuItem.md#_onpointerupaction)
- [addEventListener](IoMenuItem.md#addeventlistener)
- [applyProperties](IoMenuItem.md#applyproperties)
- [bind](IoMenuItem.md#bind)
- [changed](IoMenuItem.md#changed)
- [connectedCallback](IoMenuItem.md#connectedcallback)
- [disabledChanged](IoMenuItem.md#disabledchanged)
- [disconnectedCallback](IoMenuItem.md#disconnectedcallback)
- [dispatchEvent](IoMenuItem.md#dispatchevent)
- [dispatchMutationEvent](IoMenuItem.md#dispatchmutationevent)
- [dispatchQueue](IoMenuItem.md#dispatchqueue)
- [dispatchQueueSync](IoMenuItem.md#dispatchqueuesync)
- [dispose](IoMenuItem.md#dispose)
- [expandedChanged](IoMenuItem.md#expandedchanged)
- [focusTo](IoMenuItem.md#focusto)
- [getCaretPosition](IoMenuItem.md#getcaretposition)
- [init](IoMenuItem.md#init)
- [inputValue](IoMenuItem.md#inputvalue)
- [labelChanged](IoMenuItem.md#labelchanged)
- [objectMutated](IoMenuItem.md#objectmutated)
- [onObjectMutated](IoMenuItem.md#onobjectmutated)
- [preventDefault](IoMenuItem.md#preventdefault)
- [queue](IoMenuItem.md#queue)
- [removeEventListener](IoMenuItem.md#removeeventlistener)
- [setAttribute](IoMenuItem.md#setattribute)
- [setCaretPosition](IoMenuItem.md#setcaretposition)
- [setProperties](IoMenuItem.md#setproperties)
- [setProperty](IoMenuItem.md#setproperty)
- [template](IoMenuItem.md#template)
- [throttle](IoMenuItem.md#throttle)
- [traverse](IoMenuItem.md#traverse)
- [unbind](IoMenuItem.md#unbind)
