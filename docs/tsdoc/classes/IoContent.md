...
[elements/core/content.ts:20](https://github.com/io-gui/iogui/blob/tsc/src/elements/core/content.ts#L20)
...
[elements/core/content.ts:10](https://github.com/io-gui/iogui/blob/tsc/src/elements/core/content.ts#L10)
...
[elements/core/content.ts:33](https://github.com/io-gui/iogui/blob/tsc/src/elements/core/content.ts#L33)

___

### connect

▸ **connect**(`node?`): [`IoContent`](IoContent.md)
...
▸ **disconnect**(`node?`): [`IoContent`](IoContent.md)
