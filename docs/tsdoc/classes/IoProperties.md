...
- [constructor](IoProperties.md#constructor)

### Properties

- [$](IoProperties.md#$)
- [\_bindings](IoProperties.md#_bindings)
- [\_changeQueue](IoProperties.md#_changequeue)
- [\_eventDispatcher](IoProperties.md#_eventdispatcher)
- [\_properties](IoProperties.md#_properties)
- [\_protochain](IoProperties.md#_protochain)
- [class](IoProperties.md#class)
- [config](IoProperties.md#config)
- [contenteditable](IoProperties.md#contenteditable)
- [disabled](IoProperties.md#disabled)
- [hidden](IoProperties.md#hidden)
- [id](IoProperties.md#id)
- [label](IoProperties.md#label)
- [labeled](IoProperties.md#labeled)
- [name](IoProperties.md#name)
- [properties](IoProperties.md#properties)
- [role](IoProperties.md#role)
- [tabindex](IoProperties.md#tabindex)
- [title](IoProperties.md#title)
- [value](IoProperties.md#value)
- [widget](IoProperties.md#widget)

### Accessors

- [textNode](IoProperties.md#textnode)
- [Config](IoProperties.md#config-1)
- [Properties](IoProperties.md#properties-1)
- [Style](IoProperties.md#style)

### Methods

- [Register](IoProperties.md#register)
- [\_changedThrottled](IoProperties.md#_changedthrottled)
- [\_flattenTextNode](IoProperties.md#_flattentextnode)
- [\_onChange](IoProperties.md#_onchange)
- [\_onValueInput](IoProperties.md#_onvalueinput)
- [addEventListener](IoProperties.md#addeventlistener)
- [applyProperties](IoProperties.md#applyproperties)
- [bind](IoProperties.md#bind)
- [changed](IoProperties.md#changed)
- [connectedCallback](IoProperties.md#connectedcallback)
- [disabledChanged](IoProperties.md#disabledchanged)
- [disconnectedCallback](IoProperties.md#disconnectedcallback)
- [dispatchEvent](IoProperties.md#dispatchevent)
- [dispatchMutationEvent](IoProperties.md#dispatchmutationevent)
- [dispatchQueue](IoProperties.md#dispatchqueue)
- [dispatchQueueSync](IoProperties.md#dispatchqueuesync)
- [dispose](IoProperties.md#dispose)
- [init](IoProperties.md#init)
- [inputValue](IoProperties.md#inputvalue)
- [labelChanged](IoProperties.md#labelchanged)
- [objectMutated](IoProperties.md#objectmutated)
- [onObjectMutated](IoProperties.md#onobjectmutated)
- [queue](IoProperties.md#queue)
- [removeEventListener](IoProperties.md#removeeventlistener)
- [setAttribute](IoProperties.md#setattribute)
- [setProperties](IoProperties.md#setproperties)
- [setProperty](IoProperties.md#setproperty)
- [template](IoProperties.md#template)
- [throttle](IoProperties.md#throttle)
- [traverse](IoProperties.md#traverse)
- [unbind](IoProperties.md#unbind)
- [valueMutated](IoProperties.md#valuemutated)
...
[src/elements/object/io-properties.ts:139](https://github.com/io-gui/io/blob/main/src/elements/object/io-properties.ts#L139)
...
[src/elements/object/io-properties.ts:145](https://github.com/io-gui/io/blob/main/src/elements/object/io-properties.ts#L145)
...
[src/elements/object/io-properties.ts:136](https://github.com/io-gui/io/blob/main/src/elements/object/io-properties.ts#L136)
...
[src/elements/object/io-properties.ts:133](https://github.com/io-gui/io/blob/main/src/elements/object/io-properties.ts#L133)

___

### widget

• **widget**: [`VDOMArray`](../README.md#vdomarray)

#### Defined in

[src/elements/object/io-properties.ts:142](https://github.com/io-gui/io/blob/main/src/elements/object/io-properties.ts#L142)
...
[src/elements/object/io-properties.ts:147](https://github.com/io-gui/io/blob/main/src/elements/object/io-properties.ts#L147)
...
[src/elements/object/io-properties.ts:107](https://github.com/io-gui/io/blob/main/src/elements/object/io-properties.ts#L107)
...
[src/elements/object/io-properties.ts:220](https://github.com/io-gui/io/blob/main/src/elements/object/io-properties.ts#L220)
...
[src/elements/object/io-properties.ts:184](https://github.com/io-gui/io/blob/main/src/elements/object/io-properties.ts#L184)
...
[src/elements/object/io-properties.ts:187](https://github.com/io-gui/io/blob/main/src/elements/object/io-properties.ts#L187)
...
[src/elements/object/io-properties.ts:163](https://github.com/io-gui/io/blob/main/src/elements/object/io-properties.ts#L163)
...
[src/elements/object/io-properties.ts:181](https://github.com/io-gui/io/blob/main/src/elements/object/io-properties.ts#L181)
...
[src/elements/object/io-properties.ts:178](https://github.com/io-gui/io/blob/main/src/elements/object/io-properties.ts#L178)
