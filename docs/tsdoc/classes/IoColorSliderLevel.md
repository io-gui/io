...
• **new IoColorSliderLevel**(`properties?`)
...
[src/elements/color/color-slider-level.ts:14](https://github.com/io-gui/iogui/blob/tsc/src/elements/color/color-slider-level.ts#L14)
...
[src/elements/color/color-slider-level.ts:43](https://github.com/io-gui/iogui/blob/tsc/src/elements/color/color-slider-level.ts#L43)
...
[src/elements/color/color-slider-level.ts:39](https://github.com/io-gui/iogui/blob/tsc/src/elements/color/color-slider-level.ts#L39)
...
[src/elements/color/color-slider-level.ts:35](https://github.com/io-gui/iogui/blob/tsc/src/elements/color/color-slider-level.ts#L35)
