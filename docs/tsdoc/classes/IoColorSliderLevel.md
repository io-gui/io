...
[elements/color/color-slider-level.ts:14](https://github.com/io-gui/iogui/blob/tsc/src/elements/color/color-slider-level.ts#L14)
...
[elements/color/color-slider-level.ts:39](https://github.com/io-gui/iogui/blob/tsc/src/elements/color/color-slider-level.ts#L39)
...
[elements/color/color-slider-level.ts:35](https://github.com/io-gui/iogui/blob/tsc/src/elements/color/color-slider-level.ts#L35)
...
[elements/color/color-slider-level.ts:43](https://github.com/io-gui/iogui/blob/tsc/src/elements/color/color-slider-level.ts#L43)
