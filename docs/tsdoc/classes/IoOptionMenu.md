...
- [constructor](IoOptionMenu.md#constructor)

### Properties

- [$](IoOptionMenu.md#$)
- [\_bindings](IoOptionMenu.md#_bindings)
- [\_changeQueue](IoOptionMenu.md#_changequeue)
- [\_eventDispatcher](IoOptionMenu.md#_eventdispatcher)
- [\_properties](IoOptionMenu.md#_properties)
- [\_protochain](IoOptionMenu.md#_protochain)
- [class](IoOptionMenu.md#class)
- [contenteditable](IoOptionMenu.md#contenteditable)
- [disabled](IoOptionMenu.md#disabled)
- [hidden](IoOptionMenu.md#hidden)
- [id](IoOptionMenu.md#id)
- [label](IoOptionMenu.md#label)
- [name](IoOptionMenu.md#name)
- [options](IoOptionMenu.md#options)
- [role](IoOptionMenu.md#role)
- [tabindex](IoOptionMenu.md#tabindex)
- [title](IoOptionMenu.md#title)
- [value](IoOptionMenu.md#value)

### Accessors

- [textNode](IoOptionMenu.md#textnode)
- [Properties](IoOptionMenu.md#properties)
- [Style](IoOptionMenu.md#style)

### Methods

- [Register](IoOptionMenu.md#register)
- [\_flattenTextNode](IoOptionMenu.md#_flattentextnode)
- [\_onLeafChanged](IoOptionMenu.md#_onleafchanged)
- [addEventListener](IoOptionMenu.md#addeventlistener)
- [applyProperties](IoOptionMenu.md#applyproperties)
- [bind](IoOptionMenu.md#bind)
- [changed](IoOptionMenu.md#changed)
- [connectedCallback](IoOptionMenu.md#connectedcallback)
- [disabledChanged](IoOptionMenu.md#disabledchanged)
- [disconnectedCallback](IoOptionMenu.md#disconnectedcallback)
- [dispatchEvent](IoOptionMenu.md#dispatchevent)
- [dispatchMutationEvent](IoOptionMenu.md#dispatchmutationevent)
- [dispatchQueue](IoOptionMenu.md#dispatchqueue)
- [dispatchQueueSync](IoOptionMenu.md#dispatchqueuesync)
- [dispose](IoOptionMenu.md#dispose)
- [init](IoOptionMenu.md#init)
- [inputValue](IoOptionMenu.md#inputvalue)
- [labelChanged](IoOptionMenu.md#labelchanged)
- [objectMutated](IoOptionMenu.md#objectmutated)
- [onObjectMutated](IoOptionMenu.md#onobjectmutated)
- [optionsChanged](IoOptionMenu.md#optionschanged)
- [queue](IoOptionMenu.md#queue)
- [removeEventListener](IoOptionMenu.md#removeeventlistener)
- [setAttribute](IoOptionMenu.md#setattribute)
- [setProperties](IoOptionMenu.md#setproperties)
- [setProperty](IoOptionMenu.md#setproperty)
- [template](IoOptionMenu.md#template)
- [throttle](IoOptionMenu.md#throttle)
- [traverse](IoOptionMenu.md#traverse)
- [unbind](IoOptionMenu.md#unbind)

## Constructors

### constructor

• **new IoOptionMenu**(`...args`): [`IoOptionMenu`](IoOptionMenu.md)
...
[src/elements/menus/io-option-menu.ts:64](https://github.com/io-gui/io/blob/main/src/elements/menus/io-option-menu.ts#L64)
...
[src/elements/menus/io-option-menu.ts:67](https://github.com/io-gui/io/blob/main/src/elements/menus/io-option-menu.ts#L67)
...
[src/elements/menus/io-option-menu.ts:61](https://github.com/io-gui/io/blob/main/src/elements/menus/io-option-menu.ts#L61)
...
[src/elements/menus/io-option-menu.ts:35](https://github.com/io-gui/io/blob/main/src/elements/menus/io-option-menu.ts#L35)
...
[src/elements/menus/io-option-menu.ts:71](https://github.com/io-gui/io/blob/main/src/elements/menus/io-option-menu.ts#L71)
...
[src/elements/menus/io-option-menu.ts:85](https://github.com/io-gui/io/blob/main/src/elements/menus/io-option-menu.ts#L85)
...
[src/elements/menus/io-option-menu.ts:75](https://github.com/io-gui/io/blob/main/src/elements/menus/io-option-menu.ts#L75)
