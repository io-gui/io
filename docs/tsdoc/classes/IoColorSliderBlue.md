...
• **new IoColorSliderBlue**(`properties?`)
...
[src/elements/color/color-slider-blue.ts:14](https://github.com/io-gui/iogui/blob/tsc/src/elements/color/color-slider-blue.ts#L14)
...
[src/elements/color/color-slider-blue.ts:43](https://github.com/io-gui/iogui/blob/tsc/src/elements/color/color-slider-blue.ts#L43)
...
[src/elements/color/color-slider-blue.ts:39](https://github.com/io-gui/iogui/blob/tsc/src/elements/color/color-slider-blue.ts#L39)
...
[src/elements/color/color-slider-blue.ts:35](https://github.com/io-gui/iogui/blob/tsc/src/elements/color/color-slider-blue.ts#L35)
