...
- [constructor](IoIcon.md#constructor)

### Properties

- [$](IoIcon.md#$)
- [\_bindings](IoIcon.md#_bindings)
- [\_changeQueue](IoIcon.md#_changequeue)
- [\_eventDispatcher](IoIcon.md#_eventdispatcher)
- [\_properties](IoIcon.md#_properties)
- [\_protochain](IoIcon.md#_protochain)
- [class](IoIcon.md#class)
- [contenteditable](IoIcon.md#contenteditable)
- [disabled](IoIcon.md#disabled)
- [hidden](IoIcon.md#hidden)
- [icon](IoIcon.md#icon)
- [id](IoIcon.md#id)
- [label](IoIcon.md#label)
- [name](IoIcon.md#name)
- [role](IoIcon.md#role)
- [stroke](IoIcon.md#stroke)
- [tabindex](IoIcon.md#tabindex)
- [title](IoIcon.md#title)

### Accessors

- [textNode](IoIcon.md#textnode)
- [Properties](IoIcon.md#properties)
- [Style](IoIcon.md#style)

### Methods

- [Register](IoIcon.md#register)
- [\_flattenTextNode](IoIcon.md#_flattentextnode)
- [addEventListener](IoIcon.md#addeventlistener)
- [applyProperties](IoIcon.md#applyproperties)
- [bind](IoIcon.md#bind)
- [changed](IoIcon.md#changed)
- [connectedCallback](IoIcon.md#connectedcallback)
- [disabledChanged](IoIcon.md#disabledchanged)
- [disconnectedCallback](IoIcon.md#disconnectedcallback)
- [dispatchEvent](IoIcon.md#dispatchevent)
- [dispatchMutationEvent](IoIcon.md#dispatchmutationevent)
- [dispatchQueue](IoIcon.md#dispatchqueue)
- [dispatchQueueSync](IoIcon.md#dispatchqueuesync)
- [dispose](IoIcon.md#dispose)
- [iconChanged](IoIcon.md#iconchanged)
- [init](IoIcon.md#init)
- [inputValue](IoIcon.md#inputvalue)
- [labelChanged](IoIcon.md#labelchanged)
- [objectMutated](IoIcon.md#objectmutated)
- [onObjectMutated](IoIcon.md#onobjectmutated)
- [queue](IoIcon.md#queue)
- [removeEventListener](IoIcon.md#removeeventlistener)
- [setAttribute](IoIcon.md#setattribute)
- [setProperties](IoIcon.md#setproperties)
- [setProperty](IoIcon.md#setproperty)
- [template](IoIcon.md#template)
- [throttle](IoIcon.md#throttle)
- [traverse](IoIcon.md#traverse)
- [unbind](IoIcon.md#unbind)

## Constructors

### constructor

• **new IoIcon**(`...args`): [`IoIcon`](IoIcon.md)
...
[src/elements/basic/io-icon.ts:12](https://github.com/io-gui/io/blob/main/src/elements/basic/io-icon.ts#L12)
