...
[elements/core/icon.ts:39](https://github.com/io-gui/iogui/blob/tsc/src/elements/core/icon.ts#L39)
...
[elements/core/icon.ts:13](https://github.com/io-gui/iogui/blob/tsc/src/elements/core/icon.ts#L13)
...
▸ **disconnect**(`node?`): [`IoIcon`](IoIcon.md)
...
[elements/core/icon.ts:55](https://github.com/io-gui/iogui/blob/tsc/src/elements/core/icon.ts#L55)
