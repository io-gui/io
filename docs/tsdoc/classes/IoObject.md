...
- [constructor](IoObject.md#constructor)

### Properties

- [$](IoObject.md#$)
- [\_bindings](IoObject.md#_bindings)
- [\_changeQueue](IoObject.md#_changequeue)
- [\_eventDispatcher](IoObject.md#_eventdispatcher)
- [\_properties](IoObject.md#_properties)
- [\_protochain](IoObject.md#_protochain)
- [class](IoObject.md#class)
- [config](IoObject.md#config)
- [contenteditable](IoObject.md#contenteditable)
- [disabled](IoObject.md#disabled)
- [expanded](IoObject.md#expanded)
- [hidden](IoObject.md#hidden)
- [id](IoObject.md#id)
- [label](IoObject.md#label)
- [labeled](IoObject.md#labeled)
- [name](IoObject.md#name)
- [properties](IoObject.md#properties)
- [role](IoObject.md#role)
- [tabindex](IoObject.md#tabindex)
- [title](IoObject.md#title)
- [value](IoObject.md#value)
- [widget](IoObject.md#widget)

### Accessors

- [textNode](IoObject.md#textnode)
- [Properties](IoObject.md#properties-1)
- [Style](IoObject.md#style)

### Methods

- [Register](IoObject.md#register)
- [\_flattenTextNode](IoObject.md#_flattentextnode)
- [addEventListener](IoObject.md#addeventlistener)
- [applyProperties](IoObject.md#applyproperties)
- [bind](IoObject.md#bind)
- [changed](IoObject.md#changed)
- [connectedCallback](IoObject.md#connectedcallback)
- [disabledChanged](IoObject.md#disabledchanged)
- [disconnectedCallback](IoObject.md#disconnectedcallback)
- [dispatchEvent](IoObject.md#dispatchevent)
- [dispatchMutationEvent](IoObject.md#dispatchmutationevent)
- [dispatchQueue](IoObject.md#dispatchqueue)
- [dispatchQueueSync](IoObject.md#dispatchqueuesync)
- [dispose](IoObject.md#dispose)
- [init](IoObject.md#init)
- [inputValue](IoObject.md#inputvalue)
- [labelChanged](IoObject.md#labelchanged)
- [objectMutated](IoObject.md#objectmutated)
- [onObjectMutated](IoObject.md#onobjectmutated)
- [queue](IoObject.md#queue)
- [removeEventListener](IoObject.md#removeeventlistener)
- [setAttribute](IoObject.md#setattribute)
- [setProperties](IoObject.md#setproperties)
- [setProperty](IoObject.md#setproperty)
- [template](IoObject.md#template)
- [throttle](IoObject.md#throttle)
- [traverse](IoObject.md#traverse)
- [unbind](IoObject.md#unbind)

## Constructors

### constructor

• **new IoObject**(`...args`): [`IoObject`](IoObject.md)
...
[src/elements/object/io-object.ts:45](https://github.com/io-gui/io/blob/main/src/elements/object/io-object.ts#L45)
...
[src/elements/object/io-object.ts:57](https://github.com/io-gui/io/blob/main/src/elements/object/io-object.ts#L57)
...
[src/elements/object/io-object.ts:54](https://github.com/io-gui/io/blob/main/src/elements/object/io-object.ts#L54)
...
[src/elements/object/io-object.ts:51](https://github.com/io-gui/io/blob/main/src/elements/object/io-object.ts#L51)
...
[src/elements/object/io-object.ts:42](https://github.com/io-gui/io/blob/main/src/elements/object/io-object.ts#L42)
...
[src/elements/object/io-object.ts:60](https://github.com/io-gui/io/blob/main/src/elements/object/io-object.ts#L60)
...
[src/elements/object/io-object.ts:39](https://github.com/io-gui/io/blob/main/src/elements/object/io-object.ts#L39)
...
[src/elements/object/io-object.ts:48](https://github.com/io-gui/io/blob/main/src/elements/object/io-object.ts#L48)
...
[src/elements/object/io-object.ts:11](https://github.com/io-gui/io/blob/main/src/elements/object/io-object.ts#L11)
...
[src/elements/object/io-object.ts:62](https://github.com/io-gui/io/blob/main/src/elements/object/io-object.ts#L62)
