...
[elements/object/object.ts:34](https://github.com/io-gui/iogui/blob/tsc/src/elements/object/object.ts#L34)
...
[elements/object/object.ts:13](https://github.com/io-gui/iogui/blob/tsc/src/elements/object/object.ts#L13)
...
[elements/object/object.ts:51](https://github.com/io-gui/iogui/blob/tsc/src/elements/object/object.ts#L51)

___

### connect

▸ **connect**(`node?`): [`IoObject`](IoObject.md)
...
▸ **disconnect**(`node?`): [`IoObject`](IoObject.md)
