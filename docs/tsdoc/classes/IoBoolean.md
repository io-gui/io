...
- [constructor](IoBoolean.md#constructor)

### Properties

- [$](IoBoolean.md#$)
- [\_bindings](IoBoolean.md#_bindings)
- [\_changeQueue](IoBoolean.md#_changequeue)
- [\_eventDispatcher](IoBoolean.md#_eventdispatcher)
- [\_properties](IoBoolean.md#_properties)
- [\_protochain](IoBoolean.md#_protochain)
- [appearance](IoBoolean.md#appearance)
- [class](IoBoolean.md#class)
- [contenteditable](IoBoolean.md#contenteditable)
- [disabled](IoBoolean.md#disabled)
- [false](IoBoolean.md#false)
- [hidden](IoBoolean.md#hidden)
- [icon](IoBoolean.md#icon)
- [id](IoBoolean.md#id)
- [invalid](IoBoolean.md#invalid)
- [label](IoBoolean.md#label)
- [name](IoBoolean.md#name)
- [placeholder](IoBoolean.md#placeholder)
- [role](IoBoolean.md#role)
- [selected](IoBoolean.md#selected)
- [stroke](IoBoolean.md#stroke)
- [tabindex](IoBoolean.md#tabindex)
- [title](IoBoolean.md#title)
- [true](IoBoolean.md#true)
- [value](IoBoolean.md#value)

### Accessors

- [textNode](IoBoolean.md#textnode)
- [Listeners](IoBoolean.md#listeners)
- [Properties](IoBoolean.md#properties)
- [Style](IoBoolean.md#style)

### Methods

- [Register](IoBoolean.md#register)
- [\_flattenTextNode](IoBoolean.md#_flattentextnode)
- [\_onBlur](IoBoolean.md#_onblur)
- [\_onClick](IoBoolean.md#_onclick)
- [\_onFocus](IoBoolean.md#_onfocus)
- [\_onFocusTo](IoBoolean.md#_onfocusto)
- [\_onKeydown](IoBoolean.md#_onkeydown)
- [\_onKeyup](IoBoolean.md#_onkeyup)
- [\_onPointerdown](IoBoolean.md#_onpointerdown)
- [\_onPointerleave](IoBoolean.md#_onpointerleave)
- [\_onPointermove](IoBoolean.md#_onpointermove)
- [\_onPointerup](IoBoolean.md#_onpointerup)
- [addEventListener](IoBoolean.md#addeventlistener)
- [applyProperties](IoBoolean.md#applyproperties)
- [bind](IoBoolean.md#bind)
- [changed](IoBoolean.md#changed)
- [connectedCallback](IoBoolean.md#connectedcallback)
- [disabledChanged](IoBoolean.md#disabledchanged)
- [disconnectedCallback](IoBoolean.md#disconnectedcallback)
- [dispatchEvent](IoBoolean.md#dispatchevent)
- [dispatchMutationEvent](IoBoolean.md#dispatchmutationevent)
- [dispatchQueue](IoBoolean.md#dispatchqueue)
- [dispatchQueueSync](IoBoolean.md#dispatchqueuesync)
- [dispose](IoBoolean.md#dispose)
- [focusTo](IoBoolean.md#focusto)
- [getCaretPosition](IoBoolean.md#getcaretposition)
- [init](IoBoolean.md#init)
- [inputValue](IoBoolean.md#inputvalue)
- [labelChanged](IoBoolean.md#labelchanged)
- [objectMutated](IoBoolean.md#objectmutated)
- [onObjectMutated](IoBoolean.md#onobjectmutated)
- [queue](IoBoolean.md#queue)
- [removeEventListener](IoBoolean.md#removeeventlistener)
- [setAttribute](IoBoolean.md#setattribute)
- [setCaretPosition](IoBoolean.md#setcaretposition)
- [setProperties](IoBoolean.md#setproperties)
- [setProperty](IoBoolean.md#setproperty)
- [template](IoBoolean.md#template)
- [throttle](IoBoolean.md#throttle)
- [toggle](IoBoolean.md#toggle)
- [traverse](IoBoolean.md#traverse)
- [unbind](IoBoolean.md#unbind)

## Constructors

### constructor

• **new IoBoolean**(`...args`): [`IoBoolean`](IoBoolean.md)
...
[src/elements/basic/io-boolean.ts:43](https://github.com/io-gui/io/blob/main/src/elements/basic/io-boolean.ts#L43)
