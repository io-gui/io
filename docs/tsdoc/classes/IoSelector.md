...
- [constructor](IoSelector.md#constructor)

### Properties

- [$](IoSelector.md#$)
- [\_bindings](IoSelector.md#_bindings)
- [\_changeQueue](IoSelector.md#_changequeue)
- [\_eventDispatcher](IoSelector.md#_eventdispatcher)
- [\_properties](IoSelector.md#_properties)
- [\_protochain](IoSelector.md#_protochain)
- [cache](IoSelector.md#cache)
- [class](IoSelector.md#class)
- [contenteditable](IoSelector.md#contenteditable)
- [disabled](IoSelector.md#disabled)
- [elements](IoSelector.md#elements)
- [hidden](IoSelector.md#hidden)
- [id](IoSelector.md#id)
- [label](IoSelector.md#label)
- [loading](IoSelector.md#loading)
- [name](IoSelector.md#name)
- [options](IoSelector.md#options)
- [precache](IoSelector.md#precache)
- [role](IoSelector.md#role)
- [select](IoSelector.md#select)
- [tabindex](IoSelector.md#tabindex)
- [title](IoSelector.md#title)

### Accessors

- [textNode](IoSelector.md#textnode)
- [Properties](IoSelector.md#properties)
- [Style](IoSelector.md#style)

### Methods

- [Register](IoSelector.md#register)
- [\_flattenTextNode](IoSelector.md#_flattentextnode)
- [addEventListener](IoSelector.md#addeventlistener)
- [applyProperties](IoSelector.md#applyproperties)
- [bind](IoSelector.md#bind)
- [changed](IoSelector.md#changed)
- [connectedCallback](IoSelector.md#connectedcallback)
- [disabledChanged](IoSelector.md#disabledchanged)
- [disconnectedCallback](IoSelector.md#disconnectedcallback)
- [dispatchEvent](IoSelector.md#dispatchevent)
- [dispatchMutationEvent](IoSelector.md#dispatchmutationevent)
- [dispatchQueue](IoSelector.md#dispatchqueue)
- [dispatchQueueSync](IoSelector.md#dispatchqueuesync)
- [dispose](IoSelector.md#dispose)
- [importModule](IoSelector.md#importmodule)
- [init](IoSelector.md#init)
- [inputValue](IoSelector.md#inputvalue)
- [labelChanged](IoSelector.md#labelchanged)
- [objectMutated](IoSelector.md#objectmutated)
- [onLoadPrecache](IoSelector.md#onloadprecache)
- [onObjectMutated](IoSelector.md#onobjectmutated)
- [optionsMutated](IoSelector.md#optionsmutated)
- [queue](IoSelector.md#queue)
- [removeEventListener](IoSelector.md#removeeventlistener)
- [setAttribute](IoSelector.md#setattribute)
- [setProperties](IoSelector.md#setproperties)
- [setProperty](IoSelector.md#setproperty)
- [template](IoSelector.md#template)
- [throttle](IoSelector.md#throttle)
- [traverse](IoSelector.md#traverse)
- [unbind](IoSelector.md#unbind)

## Constructors

### constructor

• **new IoSelector**(`...args`): [`IoSelector`](IoSelector.md)
...
[src/elements/content/io-selector.ts:60](https://github.com/io-gui/io/blob/main/src/elements/content/io-selector.ts#L60)
...
[src/elements/content/io-selector.ts:63](https://github.com/io-gui/io/blob/main/src/elements/content/io-selector.ts#L63)
...
[src/elements/content/io-selector.ts:16](https://github.com/io-gui/io/blob/main/src/elements/content/io-selector.ts#L16)
...
[src/elements/content/io-selector.ts:190](https://github.com/io-gui/io/blob/main/src/elements/content/io-selector.ts#L190)
...
[src/elements/content/io-selector.ts:88](https://github.com/io-gui/io/blob/main/src/elements/content/io-selector.ts#L88)
...
[src/elements/content/io-selector.ts:73](https://github.com/io-gui/io/blob/main/src/elements/content/io-selector.ts#L73)
...
[src/elements/content/io-selector.ts:172](https://github.com/io-gui/io/blob/main/src/elements/content/io-selector.ts#L172)
