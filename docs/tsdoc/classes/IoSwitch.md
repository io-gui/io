...
[elements/core/switch.ts:13](https://github.com/io-gui/iogui/blob/tsc/src/elements/core/switch.ts#L13)
...
[elements/core/switch.ts:75](https://github.com/io-gui/iogui/blob/tsc/src/elements/core/switch.ts#L75)
...
[elements/core/switch.ts:72](https://github.com/io-gui/iogui/blob/tsc/src/elements/core/switch.ts#L72)

___

### connect

▸ **connect**(`node?`): [`IoSwitch`](IoSwitch.md)
...
▸ **disconnect**(`node?`): [`IoSwitch`](IoSwitch.md)
