...
- [constructor](IoSwitch.md#constructor)

### Properties

- [$](IoSwitch.md#$)
- [\_bindings](IoSwitch.md#_bindings)
- [\_changeQueue](IoSwitch.md#_changequeue)
- [\_eventDispatcher](IoSwitch.md#_eventdispatcher)
- [\_properties](IoSwitch.md#_properties)
- [\_protochain](IoSwitch.md#_protochain)
- [appearance](IoSwitch.md#appearance)
- [class](IoSwitch.md#class)
- [contenteditable](IoSwitch.md#contenteditable)
- [disabled](IoSwitch.md#disabled)
- [false](IoSwitch.md#false)
- [hidden](IoSwitch.md#hidden)
- [icon](IoSwitch.md#icon)
- [id](IoSwitch.md#id)
- [invalid](IoSwitch.md#invalid)
- [label](IoSwitch.md#label)
- [name](IoSwitch.md#name)
- [placeholder](IoSwitch.md#placeholder)
- [role](IoSwitch.md#role)
- [selected](IoSwitch.md#selected)
- [stroke](IoSwitch.md#stroke)
- [tabindex](IoSwitch.md#tabindex)
- [title](IoSwitch.md#title)
- [true](IoSwitch.md#true)
- [value](IoSwitch.md#value)

### Accessors

- [textNode](IoSwitch.md#textnode)
- [Listeners](IoSwitch.md#listeners)
- [Properties](IoSwitch.md#properties)
- [Style](IoSwitch.md#style)

### Methods

- [Register](IoSwitch.md#register)
- [\_flattenTextNode](IoSwitch.md#_flattentextnode)
- [\_onBlur](IoSwitch.md#_onblur)
- [\_onClick](IoSwitch.md#_onclick)
- [\_onFocus](IoSwitch.md#_onfocus)
- [\_onFocusTo](IoSwitch.md#_onfocusto)
- [\_onKeydown](IoSwitch.md#_onkeydown)
- [\_onKeyup](IoSwitch.md#_onkeyup)
- [\_onPointerdown](IoSwitch.md#_onpointerdown)
- [\_onPointerleave](IoSwitch.md#_onpointerleave)
- [\_onPointermove](IoSwitch.md#_onpointermove)
- [\_onPointerup](IoSwitch.md#_onpointerup)
- [addEventListener](IoSwitch.md#addeventlistener)
- [applyProperties](IoSwitch.md#applyproperties)
- [bind](IoSwitch.md#bind)
- [changed](IoSwitch.md#changed)
- [connectedCallback](IoSwitch.md#connectedcallback)
- [disabledChanged](IoSwitch.md#disabledchanged)
- [disconnectedCallback](IoSwitch.md#disconnectedcallback)
- [dispatchEvent](IoSwitch.md#dispatchevent)
- [dispatchMutationEvent](IoSwitch.md#dispatchmutationevent)
- [dispatchQueue](IoSwitch.md#dispatchqueue)
- [dispatchQueueSync](IoSwitch.md#dispatchqueuesync)
- [dispose](IoSwitch.md#dispose)
- [focusTo](IoSwitch.md#focusto)
- [getCaretPosition](IoSwitch.md#getcaretposition)
- [init](IoSwitch.md#init)
- [inputValue](IoSwitch.md#inputvalue)
- [labelChanged](IoSwitch.md#labelchanged)
- [objectMutated](IoSwitch.md#objectmutated)
- [onObjectMutated](IoSwitch.md#onobjectmutated)
- [queue](IoSwitch.md#queue)
- [removeEventListener](IoSwitch.md#removeeventlistener)
- [setAttribute](IoSwitch.md#setattribute)
- [setCaretPosition](IoSwitch.md#setcaretposition)
- [setProperties](IoSwitch.md#setproperties)
- [setProperty](IoSwitch.md#setproperty)
- [template](IoSwitch.md#template)
- [throttle](IoSwitch.md#throttle)
- [toggle](IoSwitch.md#toggle)
- [traverse](IoSwitch.md#traverse)
- [unbind](IoSwitch.md#unbind)
- [valueChanged](IoSwitch.md#valuechanged)
...
[src/elements/basic/io-switch.ts:11](https://github.com/io-gui/io/blob/main/src/elements/basic/io-switch.ts#L11)
...
[src/elements/basic/io-switch.ts:69](https://github.com/io-gui/io/blob/main/src/elements/basic/io-switch.ts#L69)
...
[src/elements/basic/io-switch.ts:66](https://github.com/io-gui/io/blob/main/src/elements/basic/io-switch.ts#L66)
...
[src/elements/basic/io-switch.ts:72](https://github.com/io-gui/io/blob/main/src/elements/basic/io-switch.ts#L72)
