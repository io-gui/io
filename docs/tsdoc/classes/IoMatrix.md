...
[elements/math/matrix.ts:38](https://github.com/io-gui/iogui/blob/tsc/src/elements/math/matrix.ts#L38)
...
[elements/math/matrix.ts:16](https://github.com/io-gui/iogui/blob/tsc/src/elements/math/matrix.ts#L16)
...
[elements/math/matrix.ts:55](https://github.com/io-gui/iogui/blob/tsc/src/elements/math/matrix.ts#L55)
...
[elements/math/matrix.ts:81](https://github.com/io-gui/iogui/blob/tsc/src/elements/math/matrix.ts#L81)

___

### connect

▸ **connect**(`node?`): [`IoMatrix`](IoMatrix.md)
...
▸ **disconnect**(`node?`): [`IoMatrix`](IoMatrix.md)
...
[elements/math/matrix.ts:65](https://github.com/io-gui/iogui/blob/tsc/src/elements/math/matrix.ts#L65)
