...
For a quick start, read this document, then check out included [collection of elements](https://io-gui.dev/#doc=elements-core) and the [source code](https://github.com/io-gui/io/).
...
Io design system includes a [collection of UI elements](https://io-gui.dev/#doc=elements-core) that range from simple input fields, to [menu systems](#doc=elements-menus) and [responsive layouts](#doc=elements-layout).
...
> Continue reading [advanced usage](#doc=learn-more) or check out the [included elements](#doc=elements-core).
