...
export class IoInspectorDemo extends ReactiveElement {
    ...
    selectedChanged() {
        ...
        if (oldElement)
            oldElement.removeEventListener('io-mutation', this.onElementMutated);
        if (this.selected) {
            ...
            element.addEventListener('io-mutation', this.onElementMutated);
...
export const ioInspectorDemo = (arg0) => IoInspectorDemo.vConstructor(arg0);
