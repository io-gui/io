...
export default class {
  run() {
    describe('MenuOptions', () => {
      ...
      // });
      // it('Should return item with specified value using `.findItemByValue([value])`', () => {
      //   const subItem1 = new MenuItem({value: 1});
      //   const subItem2 = new MenuItem({value: 2});
      //   const options = new MenuOptions([subItem1, subItem2]);
      //   expect(options.findItemByValue(1)).to.be.equal(subItem1);
      //   expect(options.findItemByValue(2)).to.be.equal(subItem2);
      // });
      // it('Should update `path` and `selected` properties when items are selected', () => {
      ...
      //   expect(options.selected).to.be.equal(3);
      // });
      // it('Should update `first` and items\' `selected` properties when `path` property is set', () => {
      ...
      //   expect(options.selected).to.be.equal(3);
      // });
      // it('Should update `path` and items\' `selected` properties when `first` property is set', () => {
      //   const options = new MenuOptions([1, {value: 2, label: 'two'}, 3]);
      //   options.first = 1;
      //   expect(options.path).to.be.equal('1');
      //   expect(options[0].selected).to.be.equal(true);
      ...
      //   expect(options.selected).to.be.equal(3);
      // });
      // it('Should update `first`, `path` properties only when items with `mode="pick"` are selected', () => {
      ...
      //   expect(options.selected).to.be.equal(1);
      // });
      // it('Should update deep `first` and `path` string when items are selected', () => {
      ...
      //   expect(options[0].selected).to.be.equal(false);
      //   expect(options.first).to.be.equal(2);
      //   expect(options.selected).to.be.equal('bar');
      //   expect(options[1].options.first).to.be.equal('bar');
      //   expect(options[1].options.selected).to.be.equal('bar');
      ...
      //   expect(options.first).to.be.equal(2);
      //   expect(options.selected).to.be.equal('foo');
      //   expect(options[1].options.first).to.be.equal('foo');
      //   expect(options[1].options.selected).to.be.equal('foo');
      ...
      //   expect(options[1].options[1].selected).to.be.equal(false);
      //   expect(options.first).to.be.equal(3);
      //   expect(options.selected).to.be.NaN;
      //   expect(options[2].options.first).to.be.equal('buzz');
      //   expect(options[2].options.selected).to.be.NaN;
      //   expect(options[2].options[2].options.first).to.be.NaN;
      //   expect(options[2].options[2].options.selected).to.be.NaN;
      ...
      //   expect(options[2].options.selected).to.be.equal(undefined);
      //   expect(options[2].options[2].options.first).to.be.equal(undefined);
      //   expect(options[2].options[2].options.selected).to.be.equal(undefined);
      ...
      //   expect(options.selected).to.be.equal('scrolls');
      ...
      //   expect(options[3].options.selected).to.be.equal(undefined);
      //   expect(options[3].options.scroll).to.be.equal('scroll2');
      // });
      // it('Should update deep `first` and items\' `selected` properties when `path` property is set', () => {
      //   const options = new MenuOptions(testOptions);
      //   options.path = '1';
      //   expect(options[0].selected).to.be.equal(true);
      //   expect(options.first).to.be.equal(1);
      ...
      //   expect(options[1].options.selected).to.be.equal(undefined);
      //   expect(options[0].options.first).to.be.equal('foo');
      //   expect(options[0].options.selected).to.be.equal('foo');
      ...
      //   expect(options.first).to.be.equal(1);
      //   expect(options.selected).to.be.equal('buzz');
      //   expect(options[0].options.first).to.be.equal('buzz');
      //   expect(options[0].options.selected).to.be.equal('buzz');
      ...
      //   expect(options[0].options.selected).to.be.equal(undefined);
      ...
      //   expect(options.first).to.be.equal(3);
      //   expect(options.selected).to.be.equal(null);
      //   expect(options[1].options.first).to.be.equal(undefined);
      //   expect(options[1].options.selected).to.be.equal(undefined);
      //   expect(options[2].options.first).to.be.equal('buzz');
      //   expect(options[2].options.selected).to.be.equal(null);
      //   expect(options[2].options[2].options.first).to.be.equal(null);
      //   expect(options[2].options[2].options.selected).to.be.equal(null);
      ...
      // });
      // it('Should update deep `selected`, `path` and items\' `selected` properties when `first` property is set', () => {
      //   const options = new MenuOptions(testOptions);
      //   options.first = 1;
      //   expect(options[0].selected).to.be.equal(true);
      //   expect(options.first).to.be.equal(1);
      ...
      //   expect(options[2].options[2].options.selected).to.be.equal(null);
      // });
      // it('Should update `path`, `first` and `selected` on initialization when selected items are provided.', () => {
      ...
      //   expect(options[1].options.selected).to.be.equal(null);
      ...
      //   expect(options[1].options[2].options.selected).to.be.equal(null);
      // });
