...
export declare const ioSwitch: (arg0?: import("./io-boolean").IoBooleanArgs | Array<import("io-gui").VDOMElement | null> | string, arg1?: Array<import("io-gui").VDOMElement | null> | string) => import("io-gui").VDOMElement;
