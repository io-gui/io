...
export class IoLayoutDemo extends IoElement {
  ...
  ready() {
    this.render([
      ioLayout({
        elements: [
          {tag: 'io-inputs-demo', props: {id: 'Inputs', import: './packages/io-inputs/build/demos/IoInputsDemo.js'}},
          {tag: 'io-icons-demo', props: {id: 'Icons', import: './packages/io-icons/build/demos/IoIconsDemo.js'}},
          {tag: 'io-sliders-demo', props: {id: 'Sliders', import: './packages/io-sliders/build/demos/IoSlidersDemo.js'}},
          {tag: 'io-colors-demo', props: {id: 'Colors', import: './packages/io-colors/build/demos/IoColorsDemo.js'}},
