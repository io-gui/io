...
import { IoNode, Register, EventDispatcher } from '../../index';
const handlerFunction = (event) => {
    event.target.eventStack.push(`handlerFunction ${event.detail}`);
};
let MockIoNode1 = class MockIoNode1 extends IoNode {
    eventStack = [];
...
MockIoNode1 = __decorate([
    Register
], MockIoNode1);
let MockIoNode2 = class MockIoNode2 extends MockIoNode1 {
    eventStack = [];
    static get Listeners() {
        return {
...
MockIoNode2 = __decorate([
    Register
], MockIoNode2);
let MockIoNode3 = class MockIoNode3 extends MockIoNode2 {
    eventStack = [];
    static get Listeners() {
        return {
