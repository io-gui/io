...
import { ProtoChain, IoNode, IoNodeMixin, Property, IoElement, Register } from '../../index';
...
let IoNode4 = class IoNode4 extends IoNode1 {
};
__decorate([
    Property({ init: true })
], IoNode4.prototype, "prop1", void 0);
__decorate([
    Property({})
], IoNode4.prototype, "prop2", void 0);
IoNode4 = __decorate([
    Register
], IoNode4);
    ...
    run() {
        describe('protoChain.test.ts', () => {
            ...
            it('Should bind auto-binding functions with `.autobindHandlers(node)` function', () => {
                ...
                protoChain.autobindHandlers(node);
