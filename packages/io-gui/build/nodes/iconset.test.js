    ...
    run() {
        describe('IoIconsetSingleton', () => {
            ...
            it('registers icons', () => {
                ...
                expect(IoIconsetSingleton.getIcon('test-please-ignore:dummy')).to.equal('<svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet"><g class="icon-id-dummy"><path></path></g></svg>');
            });
        });
    }
}
