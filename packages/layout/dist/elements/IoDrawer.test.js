...
describe('IoDrawer', () => {
    ...
    describe('Trailing Direction', () => {
        ...
        it('should invert drag delta for trailing direction', () => {
            const handle = trailingDrawer.querySelector('.io-drawer-handle');
            const downEvent = new PointerEvent('pointerdown', {
                pointerId: 1,
                clientX: 100,
                clientY: 50,
    ...
    describe('Vertical Orientation', () => {
        ...
        it('should use clientY for vertical drag', () => {
            const handle = verticalDrawer.querySelector('.io-drawer-handle');
            const downEvent = new PointerEvent('pointerdown', {
                pointerId: 1,
                clientX: 50,
                clientY: 10,
...
//# sourceMappingURL=IoDrawer.test.js.map