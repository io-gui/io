    ...
    run() {
        describe('IoColorPanelSingleton.test', () => {
            ...
            it('has correct sliders', async () => {
                ...
                expect(element.children[0].channel).to.equal('sv');
                expect(element.children[1].localName).to.equal('io-color-slider');
                expect(element.children[1].channel).to.equal('h');
                expect(element.children[2].localName).to.equal('io-color-slider');
                expect(element.children[2].channel).to.equal('a');
...
//# sourceMappingURL=IoColorPanelSingleton.test.js.map