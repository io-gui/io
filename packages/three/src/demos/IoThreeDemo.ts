...
const allClasses = {
  // Core
  // bufferAttribute: new BufferAttribute(new Float32Array(100), 1),
  // BufferGeometry: new BufferGeometry(),
  // clock: new Clock(),
  // instancedBufferAttribute: new InstancedBufferAttribute(new Float32Array(100), 1),
  // instancedBufferGeometry: new InstancedBufferGeometry(),
  // instancedInterleavedBuffer: new InstancedInterleavedBuffer(new Float32Array(100), 1),
  // interleavedBuffer: new InterleavedBuffer(new Float32Array(100), 1),
  // interleavedBufferAttribute: new InterleavedBufferAttribute(new InterleavedBuffer(new Float32Array(100), 1), 3, 0, false),
  // layers: new Layers(),
  // object3d: new Object3D(),
  // Raycaster: new Raycaster(),
  // renderTarget: new RenderTarget(100, 100),
  // renderTarget3D: new RenderTarget3D(100, 100, 100),
  // timer: new Timer(),
  // Scenes
