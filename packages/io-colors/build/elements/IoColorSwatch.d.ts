...
export declare const ioColorSwatch: (arg0?: import("./IoColorBase").IoColorBaseArgs | Array<import("io-gui").VDOMElement | null> | string, arg1?: Array<import("io-gui").VDOMElement | null> | string) => import("io-gui").VDOMElement;
