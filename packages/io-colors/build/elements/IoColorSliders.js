...
let IoColorSlider = class IoColorSlider extends IoColorBase {
    ...
    changed() {
        ...
        switch (c) {
            case 'r':
                slider = ioColorSliderR();
                break;
            case 'g':
                slider = ioColorSliderG();
                break;
            case 'b':
                slider = ioColorSliderB();
                break;
            case 'a':
                slider = ioColorSliderA();
                break;
            case 'h':
                slider = ioColorSliderH();
                break;
            case 's':
                slider = ioColorSliderS();
                break;
            case 'v':
                slider = ioColorSliderV();
                break;
            case 'l':
                slider = ioColorSliderL();
                break;
            case 'hs':
                slider = ioColorSliderHs();
                break;
            case 'sv':
                slider = ioColorSliderSv();
                break;
            case 'sl':
                slider = ioColorSliderSl();
                break;
        }
        let value = 0;
        let color = [0, 0, 0, 0];
...
export const ioColorSlider = function (arg0) {
...
export const ioColorSliderR = function (arg0) {
...
export const ioColorSliderG = function (arg0) {
...
export const ioColorSliderB = function (arg0) {
...
export const ioColorSliderA = function (arg0) {
...
export const ioColorSliderH = function (arg0) {
...
export const ioColorSliderS = function (arg0) {
...
export const ioColorSliderV = function (arg0) {
...
export const ioColorSliderL = function (arg0) {
...
export const ioColorSliderHs = function (arg0) {
...
export const ioColorSliderSv = function (arg0) {
