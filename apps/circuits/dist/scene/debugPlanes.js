import { Group, Mesh, PlaneGeometry, Texture, } from 'three/webgpu';
import { DebugStateMaterial } from './materials/DebugStateMaterial.js';
const DEBUG_PLANE_Z = 2;
const PREVIEW_HEIGHT_FRACTION = 0.1;
export class DebugPlanes extends Group {
    _planes;
    _planeGeometry;
    constructor(padsTexture = new Texture(), layer0Texture = new Texture(), layer1Texture = new Texture()) {
        super();
    ...
    update(boardWidth, boardHeight, padsTexture, layer0Texture, layer1Texture) {
    ...
    _createPlane(textureIndex, padsTexture, layer0Texture, layer1Texture) {
...
//# sourceMappingURL=debugPlanes.js.map