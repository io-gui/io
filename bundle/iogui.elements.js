...
`}static get Frag(){return`
    ...
    }`}}RegisterIoElement(IoSlider);const convert={rgb:{channels:3,labels:"rgb"},hsl:{channels:3,labels:"hsl"},hsv:{channels:3,labels:"hsv"},hwb:{channels:3,labels:"hwb"},cmyk:{channels:4,labels:"cmyk"},xyz:{channels:3,labels:"xyz"},lab:{channels:3,labels:"lab"},lch:{channels:3,labels:"lch"},hex:{channels:1,labels:["hex"]},ansi16:{channels:1,labels:["ansi16"]},ansi256:{channels:1,labels:["ansi256"]},hcg:{channels:3,labels:["h","c","g"]},apple:{channels:3,labels:["r16","g16","b16"]},gray:{channels:1,labels:["gray"]}};for(const Vd of Object.keys(convert)){if(!("channels"in convert[Vd]))throw new Error("missing channels property: "+Vd);if(!("labels"in convert[Vd]))throw new Error("missing channel labels property: "+Vd);if(convert[Vd].labels.length!==convert[Vd].channels)throw new Error("channel and label counts mismatch: "+Vd);const{channels:Wd,labels:Xd}=convert[Vd];delete convert[Vd].channels,delete convert[Vd].labels,Object.defineProperty(convert[Vd],"channels",{value:Wd}),Object.defineProperty(convert[Vd],"labels",{value:Xd})}function IoColorMixin(e){return class extends e{static get Properties(){return{value:{value:[1,1,1,1],observe:!0},rgb:[1,1,1],hsv:[1,1,1],hsl:[1,1,1],cmyk:[1,1,1,1],alpha:1,mode:0}}static get GlUtils(){return`
