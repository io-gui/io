...
getStorageHashes();
let IoStorage = class IoStorage extends IoNode {
    constructor(props) {
...
__decorate([
    IoProperty({ value: '' })
], IoStorage.prototype, "key", void 0);
__decorate([
    IoProperty({ value: undefined })
], IoStorage.prototype, "value", void 0);
__decorate([
    IoProperty({ value: undefined })
], IoStorage.prototype, "default", void 0);
__decorate([
    IoProperty({ value: 'none' })
], IoStorage.prototype, "storage", void 0);
IoStorage = __decorate([
    RegisterIoNode
], IoStorage);
export { IoStorage };
