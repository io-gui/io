...
export declare type ListenerDefinitionWeak = string | CustomEventListener | [string | CustomEventListener, AddEventListenerOptions?];
export declare type ListenerDefinition = [string | CustomEventListener, AddEventListenerOptions?];
/**
...
export declare type Listener = [CustomEventListener, AddEventListenerOptions?];
