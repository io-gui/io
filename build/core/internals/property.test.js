...
import { Binding, ProtoProperty, PropertyInstance, IoProperty, IoNode, RegisterIoNode, PropertyDecorators } from '../../iogui.js';
class Object1 {
    prop = true;
}
let TestIoNode = class TestIoNode extends IoNode {
    ...
    run() {
        describe('Property', () => {
            ...
            it('Should register property declarations from decorators.', () => {
                ...
                __decorate([
                    IoProperty('value1')
                ], TestClass.prototype, "prop1", void 0);
                __decorate([
                    IoProperty({ value: 'value2', type: String })
                ], TestClass.prototype, "prop2", void 0);
