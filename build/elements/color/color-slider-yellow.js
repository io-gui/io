 ...
 * '></io-element-demo>
 **/
let IoColorSliderYellow = class IoColorSliderYellow extends IoColorSlider {
    static get Frag() {
        return /* glsl */ `
      varying vec2 vUv;
...
IoColorSliderYellow = __decorate([
    RegisterIoElement
], IoColorSliderYellow);
export { IoColorSliderYellow };
//# sourceMappingURL=color-slider-yellow.js.map