 ...
 * '></io-element-demo>
 **/
let IoColorVector = class IoColorVector extends IoColorMixin(IoElement) {
    static get Style() {
        return /* css */ `
    :host {
      display: flex;
    ...
    getSlotted() {
        return ['io-color-picker', { id: 'swatch', mode: this.mode, value: this.value }]; // , 'on-value-input': this._onValueSet
    }
};
IoColorVector = __decorate([
    RegisterIoElement
], IoColorVector);
export { IoColorVector };
//# sourceMappingURL=color-vector.js.map