 ...
 * '></io-element-demo>
 **/
let IoColorSliderAlpha = class IoColorSliderAlpha extends IoColorSlider {
    static get Frag() {
        return /* glsl */ `
      varying vec2 vUv;
...
IoColorSliderAlpha = __decorate([
    RegisterIoElement
], IoColorSliderAlpha);
export { IoColorSliderAlpha };
//# sourceMappingURL=color-slider-alpha.js.map