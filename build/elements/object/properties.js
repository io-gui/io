    ...
    _onChange() {
        ...
        for (let i = 0; i < properties.length; i++) {
            ...
            if (!this.properties.length || this.properties.indexOf(c) !== -1) {
                ...
                const itemConfig = { title: label, id: c, value: this.value[c], 'on-value-input': this._onValueSet };
                itemConfig.config = this.config;
                elements.push(this.labeled ? ['span', { class: 'io-field' }, label + ':'] : null, [tag, Object.assign(itemConfig, protoConfig)]);
            }
        }
