import { IoSelectorSidebar, IoStorageFactory } from './io-elements.js';
import './io-extras.js';
...
// TODO: move to extras
class IoDocs extends IoSelectorSidebar {
  static get Style() {
    return /* css */`
  ...
  static get Properties() {
    return {
      ...
      collapseWidth: 640,
      selected: IoStorageFactory({value: docPath + 'getting-started', storage: 'hash', key: 'doc'}),
      options: [
