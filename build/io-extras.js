import { IoStorageFactory, IoThemeSingleton } from './io-elements.js';
 ...
 */
let InlineLexer_1 = class InlineLexer {
...
class IoMdView extends IoElement {
  ...
  parseMarkdown(markdown) {
    if (marked_1) {
      ...
      this.innerHTML = marked_1(markdown);
...
IoStorageFactory({key: 'demo:boolean', value: true});
IoStorageFactory({key: 'demo:string', value: 'Hello io!'});
IoStorageFactory({key: 'demo:leet', value: 1337});
IoStorageFactory({key: 'demo:number', value: 0});
IoStorageFactory({key: 'demo:theme', value: IoThemeSingleton.bind('theme')});
IoStorageFactory({key: 'demo:menuoptions', value: options});
IoStorageFactory({key: 'demo:longmenuoptions', value: longOptions});
IoStorageFactory({key: 'demo:menuoption', value: option});
IoStorageFactory({key: 'demo:rgba', value: {'r': 1, 'g': 0.5, 'b': 0, 'a': 1}});
IoStorageFactory({key: 'demo:cmyk', value: {'c': 0, 'm': 0, 'y': 0, 'k': 0}});
IoStorageFactory({key: 'demo:object', value: {
  number: 0.5,
  string: 'hello',
  boolean: true,
...
IoStorageFactory({key: 'demo:vector2', value: [0, 1]});
  ...
  propertiesChanged() {
    ...
    for (let p in this.properties) {
      ...
      if (typeof prop === 'string' && prop.startsWith('demo:')) {
        this.properties[p] = IoStorageFactory({key: prop});
      }
    }
  }
  changed() {
...
export { IoElementDemo, IoMdView, IoServiceLoader };
